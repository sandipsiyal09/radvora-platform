...
const sections = [
  ...
  ['Refund processing', 'Approved refunds are issued through the original or another legally permitted payment method after the return or cancellation is validated. Banks and payment providers may take additional time to reflect an approved refund.'],
