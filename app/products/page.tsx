...
const families=[
  {index:'01',name:'ShieldTag Signature',slug:'shieldtag-signature',device:'Smartphones',previewDevice:'iphone',format:'Compact identity badge',copy:'The everyday ShieldTag proportion for modern smartphone rear surfaces.'},
  {index:'02',name:'ShieldTag Pro',slug:'shieldtag-pro',device:'Tablets',previewDevice:'ipad',format:'Tablet-proportioned format',copy:'A broader ShieldTag proportion designed around larger tablet surfaces.'},
  {index:'03',name:'ShieldTag Executive',slug:'shieldtag-executive',device:'Laptops',previewDevice:'macbook',format:'Hardware-plaque expression',copy:'A restrained laptop format designed to read as part of the hardware.'},
  {index:'04',name:'ShieldTag Mini',slug:'shieldtag-mini',device:'Compact accessories',previewDevice:'buds',format:'Reduced-format badge',copy:'A smaller identity mark for compatible charging cases and compact technology.'}
]
