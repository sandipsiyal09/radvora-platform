...
const families=[
  {index:'01',name:'ShieldTag Signature',slug:'shieldtag-signature',device:'Smartphones',category:'Smartphone',format:'Compact identity badge',copy:'The everyday ShieldTag proportion for modern smartphone rear surfaces.'},
  {index:'02',name:'ShieldTag Pro',slug:'shieldtag-pro',device:'Tablets',category:'Tablet',format:'Tablet-proportioned format',copy:'A broader ShieldTag proportion designed around larger tablet surfaces.'},
  {index:'03',name:'ShieldTag Executive',slug:'shieldtag-executive',device:'Laptops',category:'Laptop',format:'Hardware-plaque expression',copy:'A restrained laptop format designed to read as part of the hardware.'},
  {index:'04',name:'ShieldTag Mini',slug:'shieldtag-mini',device:'Compact accessories',category:'Accessory',format:'Reduced-format badge',copy:'A smaller identity mark for compatible charging cases and compact technology.'}
]
