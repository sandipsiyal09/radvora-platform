...
const compatibilityCategoryByDevice:Record<string,'Smartphone'|'Laptop'|'Accessory'>={
  Smartphones:'Smartphone',
  Laptops:'Laptop',
  'Compact accessories':'Accessory'
}

export default function ShieldTagFormatPage({label,device,headline,accent,intro,proportion,placement,finish,slug}:Props){
  const category=compatibilityCategoryByDevice[device]
  const compatibilityHref=category?`/compatibility?category=${encodeURIComponent(category)}`:'/compatibility'
