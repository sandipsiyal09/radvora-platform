...
export default function Page(){return <ShieldTagFormatPage label="ShieldTag Mini" device="Compact accessories" headline="Small format." accent="Same identity." intro="ShieldTag Mini brings the RADVORA visual system to supported compact technology where the larger formats would overpower the device." proportion="Mini reduces the visual footprint for smaller approved surfaces while preserving the recognizable RADVORA identity language." placement="Keep charging contacts, lids, hinges, microphones, sensors, buttons and other functional zones clear." finish="Use ShieldLab to test how the smaller badge relates to compact hardware before relying on exact device compatibility." slug="shieldtag-mini"/>}
