...
const sections = [
  ['Information we collect', 'We may collect information you provide directly, such as your name, email address, phone number, delivery information, account details, order information, requested product-availability updates, support requests, warranty submissions, and business enquiries. We may also receive limited technical and transaction information from service providers used to operate the website and process payments.'],
  ['How we use information', 'We use personal information to operate accounts, process and fulfil orders, send product-availability updates that you explicitly request, provide support, administer warranty requests, respond to enquiries, maintain security, prevent fraud or abuse, comply with legal obligations, and improve the reliability of our services.'],
