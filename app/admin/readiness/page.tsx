...
export default async function ReadinessPage(){
  ...
  const [{data:products},{count:pendingApprovals},{count:failedWebhooks},{count:openRefunds},{count:failedRefunds},{data:agents},{data:guardrails},{data:reservationRows},{data:runtimeSchemaVersion,error:runtimeSchemaError}]=await Promise.all([
