...
export default async function ReadinessPage(){
  ...
  return <main className="page-wrap"><div className="shell">
    <section className="page-head"><span className="kicker">RADVORA INDIA LAUNCH</span><h1>Launch readiness.</h1><p>This view reports configuration, catalog, payment-operation and AI-safety blockers without exposing credentials. It does not bypass scientific, compliance, payment or human approval controls.</p></section>
