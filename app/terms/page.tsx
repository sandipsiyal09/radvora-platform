...
export const metadata: Metadata = {
  ...
  description: 'Terms governing use of the RADVORA Technologies website, accounts, products, and customer services.'
}
...
const sections = [
  ...
  ['Orders and payment', 'Submitting an order or starting checkout does not guarantee acceptance. An order is treated as paid only after successful payment confirmation through our payment systems. We may cancel or refund an order where payment fails, stock is unavailable, pricing is clearly erroneous, fraud is suspected, or fulfilment is not legally or operationally possible.'],
  ['Delivery', 'Delivery estimates are indicative unless explicitly stated otherwise. Carrier delays, address errors, customs, force majeure, or other circumstances outside reasonable control may affect delivery timing.'],
