...
const EXPECTED_RUNTIME_SCHEMA_VERSION='202609110045'
...
export async function GET(){
  ...
  try{
    ...
    if(productError||itemError||paymentError||schemaVersionError) throw productError||itemError||paymentError||schemaVersionError
