...
export default async function CartPage(){
  ...
  return <main className="page-wrap"><div className="shell">
    ...
    <div className="cart-layout">
      ...
      <aside className="panel cart-summary"><span className="kicker">ORDER SUMMARY</span><div className="summary-line"><span>Subtotal</span><b>{new Intl.NumberFormat('en-IN',{style:'currency',currency:'INR'}).format(subtotal)}</b></div><div className="summary-line"><span>Tax</span><b>Calculated later</b></div><div className="summary-line"><span>Shipping</span><b>Calculated later</b></div><p className="empty-state">Secure Stripe Checkout collects the delivery address and phone number. The order is marked paid only after a verified signed Stripe webhook confirms payment.</p><CheckoutButton disabled={!canCheckout}/><div className="actions"><Link className="pill ghost" href="/products/shieldtag-pro">Continue shopping</Link></div></aside>
    </div>
  </div></main>
}
