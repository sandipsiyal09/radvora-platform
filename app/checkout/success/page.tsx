...
export default async function CheckoutSuccessPage({searchParams}:{searchParams:Promise<{order_id?:string}>}){
  ...
  if(!user) return <PublicShell><main className="page-wrap"><div className="shell"><section className="glass bento-card"><p className="kicker">RADVORA CHECKOUT</p><h1>Sign in to view payment status.</h1><Link className="pill light" href="/login">Sign in</Link></section></div></main></PublicShell>
  ...
  return <PublicShell><main className="page-wrap"><div className="shell"><section className="glass bento-card">
