...
const devices:DeviceExample[]=[
  ...
  {id:'omnibook',brand:'HP',name:'OmniBook Ultra 14',category:'Laptop',deviceColor:'Eclipse Gray',image:'https://www.hp.com/in-en/shop/media/catalog/product/h/p/hp-omnibook-ultra-14-ngai-grahami-silk-sand-front.png?auto=avif&bg-color=ffffff&fit=bounds&format=jpg&image-type=image&quality=100&store=in-en&type=image-product&width=960',source:'https://www.hp.com/in-en/shop/products/laptops/hp-omnibook-ultra-laptop-next-gen-ai-14-kd0081tu-de8p3pa-acj',tagClass:'tagOmni',fit:'contain',tone:'sand',syncFinish:{id:'hp-eclipse-sync',name:'Eclipse Gray Sync',base:'#4b4d50',edge:'#9ca0a5',accent:'#bdefff',text:'#f7fafb'},placement:{left:'50%',bottom:'21%',scale:.64}},
